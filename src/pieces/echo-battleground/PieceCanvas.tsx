  ...
  return (
    <div ref={wrapperRef} className="relative w-full h-screen overflow-hidden bg-black">
      <div className="sr-only">
        Echo / Battleground. You are at the centre of a spherical cloud of YouTube vaccine
        videos and comments. Colour shows stance (blue in favour, red against, grey neutral),
        node size shows engagement, and motion shows controversy — calm and coherent where
        opinion agrees (an echo chamber), turbulent where it clashes (a battleground). The
        sound turns dissonant when you look toward contested content. Drag to look around,
      ...
      >
        ...
        <p className="mt-1 text-[11px] uppercase tracking-[0.25em] text-white/40">
          Tizzani &amp; Mejova · J. Med. Internet Res. 2026 · e88519
        </p>

        <p className="mt-5 text-sm leading-relaxed">
          Six months of vaccine talk on YouTube — 7,213 videos, tracked daily. Vaccine‑hesitant
          content holds a triple advantage: it draws far more engagement, saturates its audience
          faster, and settles into agreeable <em>echo chambers</em>, while pro‑vaccine content
          turns into a contested <em>battleground</em>. You are standing inside that comment space.
        </p>
        ...
        <dl className="mt-6 space-y-4 text-sm leading-relaxed">
          ...
          <div>
            ...
            <dd className="mt-0.5">
              Agreement holds particles in a calm, coherent shell; disagreement makes them
              seethe and never rest. How fast they move tracks how quickly that content saturated.
            </dd>
          </div>
          <div>
            <dt className="text-[11px] uppercase tracking-[0.2em] text-white/45">Sound — controversy, heard</dt>
            <dd className="mt-0.5">
              Face consensus and the chord stays consonant; face contention and it detunes
              into dissonance.
            </dd>
          </div>
        </dl>
        ...
        <p className="mt-6 text-[11px] leading-relaxed text-white/35">
          Motion and velocity are simulated from the paper’s stance‑level distributions; the
          sound reads the real comment agreement wherever you look. No comment text or
