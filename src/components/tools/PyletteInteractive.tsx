...
export default function PyletteInteractive() {
  ...
  return (
    <section className="mb-16 border border-[var(--border-color)] bg-[var(--bg-color)] p-6 md:p-10 rounded-lg shadow-sm">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-[var(--border-color)] pb-6 mb-8">
        <div>
          <h2 className="text-2xl font-serif text-[var(--heading-color)]">Interactive Generator</h2>
          <p className="text-sm text-[var(--text-color)] opacity-75 mt-1">
            Test Pylette Plot directly in your browser. Upload an image or select a sample below.
          </p>
        </div>
        <div className="flex items-center gap-3">
          <label className="cursor-pointer inline-flex items-center gap-2 px-4 py-2 bg-[var(--accent-color)] text-white text-xs font-semibold uppercase tracking-wider rounded hover:opacity-90 transition-opacity">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 border border-[var(--border-color)] text-[var(--heading-color)] text-xs font-semibold uppercase tracking-wider rounded hover:border-[var(--accent-color)] hover:text-[var(--accent-color)] transition-colors disabled:opacity-40"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
